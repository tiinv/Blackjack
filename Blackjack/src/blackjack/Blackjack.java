...
public class Blackjack {
    ...
    public static void main(String[] args) {
        ...
        //muuttujat pelien ja voittojen tilastointiin
        int pelit = 0;
        int voitot = 0;

        testipakka.sekoitaPakka();

        while (true) { //looppi mahdollistaa pelaamisen uudelleen
            ...
            if (pelaaja.summa <= 21) {
                ...
                if (uusiPeli.equalsIgnoreCase("N")) {
                    ...
                    pelaaja.resetSumma(); // nollataan molempien pelaajien kortit.
                    tietokone.resetSumma();
                }
            }
        }
    }}
